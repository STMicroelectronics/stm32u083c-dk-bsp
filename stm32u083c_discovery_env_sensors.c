...
/** @defgroup STM32U083C_DK_ENV_SENSORS_Private_Function_Prototypes STM32U083C-DK ENV SENSORS Private Function
              Prototypes
  * @{
  */
...
static int32_t STTS22H_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      EnvFuncDrv[ENV_SENSOR_STTS22H_0][FunctionIndex[ENV_TEMPERATURE]] = \
                                                    (ENV_SENSOR_FuncDrv_t *)(void *)&STTS22H_TEMP_Driver;
